...
return loaded(_that.orders,_that.medications,_that.branches,_that.searchQuery,_that.selectedStatus,_that.isSubmitting,_that.errorMessage);case CustomerOrdersFailure() when failure != null:
...
return loaded(_that.orders,_that.medications,_that.branches,_that.searchQuery,_that.selectedStatus,_that.isSubmitting,_that.errorMessage);case CustomerOrdersFailure():
return failure(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class CustomerOrdersLoaded implements CustomerOrdersState {
  const CustomerOrdersLoaded({required final  List<CustomerOrderModel> orders, required final  List<MedicationModel> medications, required final  List<BranchModel> branches, this.searchQuery = '', this.selectedStatus = 'all', this.isSubmitting = false, this.errorMessage = null}): _orders = orders,_medications = medications,_branches = branches;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_orders),const DeepCollectionEquality().hash(_medications),const DeepCollectionEquality().hash(_branches),searchQuery,selectedStatus,isSubmitting,errorMessage);

@override
String toString() {
  return 'CustomerOrdersState.loaded(orders: $orders, medications: $medications, branches: $branches, searchQuery: $searchQuery, selectedStatus: $selectedStatus, isSubmitting: $isSubmitting, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 List<CustomerOrderModel> orders, List<MedicationModel> medications, List<BranchModel> branches, String searchQuery, String selectedStatus, bool isSubmitting, String? errorMessage
});
...
/// Create a copy of CustomerOrdersState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? orders = null,Object? medications = null,Object? branches = null,Object? searchQuery = null,Object? selectedStatus = null,Object? isSubmitting = null,Object? errorMessage = freezed,}) {
