...
class ReportsRepo {
  const ReportsRepo({required ReportsRemoteDataSource remoteDataSource})
    : _remoteDataSource = remoteDataSource;

  final ReportsRemoteDataSource _remoteDataSource;

  Future<({ReportsSummaryModel summary, List<BranchModel> branches})>
  getReports({String branchId = 'all'}) {
    return _remoteDataSource.getReports(branchId: branchId);
  }
}
