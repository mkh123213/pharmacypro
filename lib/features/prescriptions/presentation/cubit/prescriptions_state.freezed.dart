...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<PrescriptionModel> prescriptions,  List<BranchModel> branches,  List<MedicationModel> medications,  String searchQuery,  String selectedStatus,  String selectedBranchId,  bool isSubmitting,  String? errorMessage,  bool isLoadingMore,  bool hasMore)?  loaded,TResult Function( String message)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case PrescriptionsInitial() when initial != null:
return initial();case PrescriptionsLoading() when loading != null:
return loading();case PrescriptionsLoaded() when loaded != null:
return loaded(_that.prescriptions,_that.branches,_that.medications,_that.searchQuery,_that.selectedStatus,_that.selectedBranchId,_that.isSubmitting,_that.errorMessage,_that.isLoadingMore,_that.hasMore);case PrescriptionsFailure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<PrescriptionModel> prescriptions,  List<BranchModel> branches,  List<MedicationModel> medications,  String searchQuery,  String selectedStatus,  String selectedBranchId,  bool isSubmitting,  String? errorMessage,  bool isLoadingMore,  bool hasMore)  loaded,required TResult Function( String message)  failure,}) {final _that = this;
switch (_that) {
case PrescriptionsInitial():
return initial();case PrescriptionsLoading():
return loading();case PrescriptionsLoaded():
return loaded(_that.prescriptions,_that.branches,_that.medications,_that.searchQuery,_that.selectedStatus,_that.selectedBranchId,_that.isSubmitting,_that.errorMessage,_that.isLoadingMore,_that.hasMore);case PrescriptionsFailure():
return failure(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class PrescriptionsLoaded implements PrescriptionsState {
  const PrescriptionsLoaded({required final  List<PrescriptionModel> prescriptions, required final  List<BranchModel> branches, required final  List<MedicationModel> medications, this.searchQuery = '', this.selectedStatus = 'all', this.selectedBranchId = 'all', this.isSubmitting = false, this.errorMessage = null, this.isLoadingMore = false, this.hasMore = true}): _prescriptions = prescriptions,_branches = branches,_medications = medications;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_prescriptions),const DeepCollectionEquality().hash(_branches),const DeepCollectionEquality().hash(_medications),searchQuery,selectedStatus,selectedBranchId,isSubmitting,errorMessage,isLoadingMore,hasMore);

@override
String toString() {
  return 'PrescriptionsState.loaded(prescriptions: $prescriptions, branches: $branches, medications: $medications, searchQuery: $searchQuery, selectedStatus: $selectedStatus, selectedBranchId: $selectedBranchId, isSubmitting: $isSubmitting, errorMessage: $errorMessage, isLoadingMore: $isLoadingMore, hasMore: $hasMore)';
}
...
@useResult
$Res call({
 List<PrescriptionModel> prescriptions, List<BranchModel> branches, List<MedicationModel> medications, String searchQuery, String selectedStatus, String selectedBranchId, bool isSubmitting, String? errorMessage, bool isLoadingMore, bool hasMore
});
...
/// Create a copy of PrescriptionsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? prescriptions = null,Object? branches = null,Object? medications = null,Object? searchQuery = null,Object? selectedStatus = null,Object? selectedBranchId = null,Object? isSubmitting = null,Object? errorMessage = freezed,Object? isLoadingMore = null,Object? hasMore = null,}) {
