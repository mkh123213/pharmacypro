...
extension InventoryBodyBuildInventoryErrorMessage on InventoryBody {
String _buildInventoryErrorMessage(
    ...
    switch (errorMessage) {
      ...
      case 'inventory_adjustment_quantity_required':
        return context.translate(LangKeys.inventoryAdjustmentQuantityRequired);
      case 'inventory_adjustment_reason_required':
        return context.translate(LangKeys.inventoryAdjustmentReasonRequired);
      default:
