...
class StaffState with _$StaffState {
  ...
  const factory StaffState.loaded({
    required List<StaffModel> staff, required List<BranchModel> branches, @Default('') String searchQuery, @Default('all') String selectedRole, @Default(false) bool isSubmitting,
  }) = StaffLoaded;
