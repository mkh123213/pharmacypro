...
class ShiftsRepo {
  const ShiftsRepo({required ShiftsRemoteDataSource remoteDataSource})
  ...
  Future<ShiftModel> createShift(ShiftModel item) {
    return _remoteDataSource.createShift(item);
  }

  Future<void> updateShiftFields(String id, Map<String, dynamic> data) {
    return _remoteDataSource.updateShiftFields(id, data);
  }
}
